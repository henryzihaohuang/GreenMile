...
import * as ModalReducer from '../../reducers/ui/modal_reducer';
import * as MODAL from '../../actions/modal';

const Homepage = (props) => {

    const [stateLocal1, dispatchLocal1] = useReducer(ModalReducer.ModalReducer, ModalReducer.initialState) 

    const openModal = (keyword) => {
        dispatchLocal1(MODAL.openModal(keyword))
    }
                    ...
                    <div className="first-section-block">
                        <div className="first-section-header-block">
                            ...
                            <div className="modal-page-wrapper" >
                                ...
                                <div onClick={() => openModal('disclosure')} >
